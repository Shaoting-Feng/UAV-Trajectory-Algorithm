from old_codes.Contribution_of_Coverage_Programming.calc_cont_one_obj import CalculatePoint, CalculateAngle, LineCircle, AngleAngle
import math
    ...
    def total_contribution(self, idx, q, num):
        if math.sqrt(((self.x_obj-self.x_UAV)**2) + (self.y_UAV**2)) <= self.r_obj:
            ...
            if upper_contribution == (0,0):
                ...
                return list(upper_contribution) 

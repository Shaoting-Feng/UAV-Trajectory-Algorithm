...
model = PPO("MlpPolicy", env, gamma=0.93, verbose=1, tensorboard_log = '/home/baseline/output/gamma93batch512', batch_size=512)

# edited on 08.15 for Version 8 - 1
model.learn(total_timesteps=200000, log_interval=1)

model.save('/home/baseline/output/gamma93batch512/model') 
